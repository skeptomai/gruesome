...
impl Interpreter {
    ...
    pub fn execute_object_op(
        ...
        match (inst.opcode, &inst.operand_count) {
            ...
            (0x01, crate::interpreter::core::instruction::OperandCount::OP1) => {
                // get_sibling
            ...
            // 1OP:0x02 - get_child
            (0x02, crate::interpreter::core::instruction::OperandCount::OP1) => {
                // get_child
            ...
            // 1OP:0x03 - get_parent
            (0x03, crate::interpreter::core::instruction::OperandCount::OP1) => {
                // get_parent
                debug!(
            ...
            (0x04, crate::interpreter::core::instruction::OperandCount::OP1) => {
            ...
            // 1OP:0x09 - remove_obj
            (0x09, crate::interpreter::core::instruction::OperandCount::OP1) => {
                // remove_obj
            ...
            // 1OP:0x0A - print_obj
            (0x0A, crate::interpreter::core::instruction::OperandCount::OP1) => {
            ...
            (0x06, crate::interpreter::core::instruction::OperandCount::OP2) => {
                // jin
            ...
            // 2OP:0x0A - test_attr
            (0x0A, crate::interpreter::core::instruction::OperandCount::OP2) => {
                // test_attr
                let obj_num = operands[0];
            ...
            // 2OP:0x0B - set_attr
            (0x0B, crate::interpreter::core::instruction::OperandCount::OP2) => {
                // set_attr
                let obj_num = operands[0];
                let attr_num = operands[1] as u8;
            ...
            // 2OP:0x0C - clear_attr
            (0x0C, crate::interpreter::core::instruction::OperandCount::OP2) => {
                // clear_attr
                let obj_num = operands[0];
                let attr_num = operands[1] as u8;
                if attr_num > 31 {
            ...
            // 2OP:0x0E - insert_obj
            (0x0E, crate::interpreter::core::instruction::OperandCount::OP2) => {
                // insert_obj
                debug!(
            ...
            // 2OP:0x11 - get_prop
            (0x11, crate::interpreter::core::instruction::OperandCount::OP2) => {
                // get_prop
                let obj_num = operands[0];
            ...
            (0x12, crate::interpreter::core::instruction::OperandCount::OP2) => {
                // get_prop_addr
                let obj_num = operands[0];
                let prop_num = operands[1] as u8;
            ...
            (0x13, crate::interpreter::core::instruction::OperandCount::OP2) => {
                // get_next_prop
                let obj_num = operands[0];
                let prop_num = operands[1] as u8;
            ...
            // VAR:0x03 - put_prop
            (0x03, crate::interpreter::core::instruction::OperandCount::VAR) => {
                // put_prop
                if operands.len() < 3 {
    ...
    pub fn is_object_opcode(
        ...
        matches!(
            ...
            // 1OP object operations
            (0x01, crate::interpreter::core::instruction::OperandCount::OP1) |  // get_sibling
            (0x02, crate::interpreter::core::instruction::OperandCount::OP1) |  // get_child
            (0x03, crate::interpreter::core::instruction::OperandCount::OP1) |  // get_parent
            (0x04, crate::interpreter::core::instruction::OperandCount::OP1) |  // get_prop_len
            (0x09, crate::interpreter::core::instruction::OperandCount::OP1) |  // remove_obj
            (0x0A, crate::interpreter::core::instruction::OperandCount::OP1) |  // print_obj
            // 2OP object operations
            (0x06, crate::interpreter::core::instruction::OperandCount::OP2) |  // jin
            (0x0A, crate::interpreter::core::instruction::OperandCount::OP2) |  // test_attr
            (0x0B, crate::interpreter::core::instruction::OperandCount::OP2) |  // set_attr
            (0x0C, crate::interpreter::core::instruction::OperandCount::OP2) |  // clear_attr
            (0x0E, crate::interpreter::core::instruction::OperandCount::OP2) |  // insert_obj
            (0x11, crate::interpreter::core::instruction::OperandCount::OP2) |  // get_prop
            (0x12, crate::interpreter::core::instruction::OperandCount::OP2) |  // get_prop_addr
            (0x13, crate::interpreter::core::instruction::OperandCount::OP2) |  // get_next_prop
            // VAR object operations
            (0x03, crate::interpreter::core::instruction::OperandCount::VAR) // put_prop
    ...
    pub fn is_var_13_object_opcode(
        inst: &crate::interpreter::core::instruction::Instruction,
    ) -> bool {
        inst.opcode == 0x13
