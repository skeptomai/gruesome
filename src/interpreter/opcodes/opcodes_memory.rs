...
impl Interpreter {
    ...
    pub fn execute_memory_op(
        ...
        match (inst.opcode, &inst.operand_count) {
            ...
            (0x0E, crate::interpreter::core::instruction::OperandCount::OP1) => {
            ...
            (0x0D, crate::interpreter::core::instruction::OperandCount::OP2) => {
                // store
            ...
            (0x0F, crate::interpreter::core::instruction::OperandCount::OP2) => {
                // loadw
            ...
            (0x10, crate::interpreter::core::instruction::OperandCount::OP2) => {
                // loadb
            ...
            (0x01, crate::interpreter::core::instruction::OperandCount::VAR) => {
                // storew
                if operands.len() < 3 {
                    // For Variable form with OP2, this might be 2OP:21 (storew) not VAR:01
                    if inst.form == crate::interpreter::core::instruction::InstructionForm::Variable
                        && inst.operand_count
            ...
            (0x02, crate::interpreter::core::instruction::OperandCount::VAR) => {
                // storeb
                if operands.len() < 3 {
    ...
    pub fn is_memory_opcode(
        ...
        matches!(
            ...
            // 1OP memory operations
            (0x0E, crate::interpreter::core::instruction::OperandCount::OP1) |  // load
            // 2OP memory operations  
            (0x0D, crate::interpreter::core::instruction::OperandCount::OP2) |  // store
            (0x0F, crate::interpreter::core::instruction::OperandCount::OP2) |  // loadw
            (0x10, crate::interpreter::core::instruction::OperandCount::OP2) |  // loadb
            // VAR memory operations
            (0x01, crate::interpreter::core::instruction::OperandCount::VAR) |  // storew
            (0x02, crate::interpreter::core::instruction::OperandCount::VAR) // storeb
        )
    }
}
