...
impl Interpreter {
    ...
    pub fn execute_display_op(
        ...
        match (inst.opcode, &inst.operand_count) {
            ...
            (0x02, crate::interpreter::core::instruction::OperandCount::OP0) => {
            ...
            // 0OP:0x03 - print_ret
            (0x03, crate::interpreter::core::instruction::OperandCount::OP0) => {
                if let Some(ref text) = inst.text {
                    self.output_text(text)?;
                    self.output_char('\n')?;
                }
            ...
            // 0OP:0x0B - new_line
            (0x0B, crate::interpreter::core::instruction::OperandCount::OP0) => {
                self.output_char('\n')?;
                Ok(ExecutionResult::Continue)
            }

            // 0OP:0x0C - show_status (V3 only)
            (0x0C, crate::interpreter::core::instruction::OperandCount::OP0) => {
            ...
            (0x0D, crate::interpreter::core::instruction::OperandCount::OP1) => {
                ...
                match crate::interpreter::text::decode_string_at_packed_addr(
                    &self.vm.game.memory,
                    operands[0],
            ...
            // 1OP:0x07 - print_addr
            (0x07, crate::interpreter::core::instruction::OperandCount::OP1) => {
                ...
                match crate::interpreter::text::decode_string(
                    &self.vm.game.memory,
                    addr,
                    abbrev_addr,
                ) {
            ...
            // VAR:0x05 - print_char
            (0x05, crate::interpreter::core::instruction::OperandCount::VAR) => {
            ...
            // VAR:0x06 - print_num
            (0x06, crate::interpreter::core::instruction::OperandCount::VAR) => {
                if !operands.is_empty() {
            ...
            (0x0A, crate::interpreter::core::instruction::OperandCount::VAR) => {
                if !operands.is_empty() {
            ...
            (0x0B, crate::interpreter::core::instruction::OperandCount::VAR) => {
                if !operands.is_empty() {
            ...
            (0x0D, crate::interpreter::core::instruction::OperandCount::VAR) => {
                if !operands.is_empty() {
            ...
            (0x0E, crate::interpreter::core::instruction::OperandCount::VAR) => {
            ...
            (0x10, crate::interpreter::core::instruction::OperandCount::VAR) => {
            ...
            // VAR:0x0F - set_cursor
            (0x0F, crate::interpreter::core::instruction::OperandCount::VAR) => {
                if operands.len() >= 2 {
                    let line = operands[0];
            ...
            (0x11, crate::interpreter::core::instruction::OperandCount::VAR) => {
            ...
            (0x15, crate::interpreter::core::instruction::OperandCount::VAR) => {
                if !operands.is_empty() {
            ...
            (0x12, crate::interpreter::core::instruction::OperandCount::VAR) => {
    ...
    pub fn is_display_opcode(
        ...
        matches!(
            ...
            // 0OP display operations
            (0x02, crate::interpreter::core::instruction::OperandCount::OP0) |  // print
            (0x03, crate::interpreter::core::instruction::OperandCount::OP0) |  // print_ret
            (0x0B, crate::interpreter::core::instruction::OperandCount::OP0) |  // new_line
            (0x0C, crate::interpreter::core::instruction::OperandCount::OP0) |  // show_status
            // 1OP display operations
            (0x0D, crate::interpreter::core::instruction::OperandCount::OP1) |  // print_paddr
            (0x07, crate::interpreter::core::instruction::OperandCount::OP1) |  // print_addr
            // VAR display operations
            (0x05, crate::interpreter::core::instruction::OperandCount::VAR) |  // print_char
            (0x06, crate::interpreter::core::instruction::OperandCount::VAR) |  // print_num
            (0x0A, crate::interpreter::core::instruction::OperandCount::VAR) |  // split_window
            (0x0B, crate::interpreter::core::instruction::OperandCount::VAR) |  // set_window
            (0x0D, crate::interpreter::core::instruction::OperandCount::VAR) |  // erase_window
            (0x0E, crate::interpreter::core::instruction::OperandCount::VAR) |  // erase_line
            (0x10, crate::interpreter::core::instruction::OperandCount::VAR) |  // get_cursor
            (0x0F, crate::interpreter::core::instruction::OperandCount::VAR) |  // set_cursor
            (0x11, crate::interpreter::core::instruction::OperandCount::VAR) |  // set_text_style
            (0x12, crate::interpreter::core::instruction::OperandCount::VAR) |  // buffer_mode
            (0x15, crate::interpreter::core::instruction::OperandCount::VAR) // sound_effect
        )
    }
}
