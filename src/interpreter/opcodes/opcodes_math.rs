...
impl Interpreter {
    ...
    pub fn execute_math_op(
        ...
        match (inst.opcode, &inst.operand_count) {
            ...
            (0x0F, crate::interpreter::core::instruction::OperandCount::OP1) => {
            ...
            (0x08, crate::interpreter::core::instruction::OperandCount::OP2) => {
            ...
            (0x09, crate::interpreter::core::instruction::OperandCount::OP2) => {
                log::debug!(
                    "🔍 AND_DEBUG: PC=0x{:04x}, operands.len()={}, operands={:?}, inst={:?}",
                    self.vm.pc,
                    operands.len(),
                    operands,
                    inst
                ...
                if operands.len() < 2 {
                    return Err(format!("AND instruction at PC 0x{:04x} has {} operands, expected 2. operands={:?}, inst={:?}",
                                     self.vm.pc, operands.len(), operands, inst));
                }
                debug!("and {} {}", operands[0], operands[1]);
                // Temporary debug for exit.destination (masks with 0x3FFF)
                if operands[1] == 0x3FFF {
                    log::debug!("🔍 AND for exit.destination: operands[0]=0x{:04x} ({}) & 0x3FFF = 0x{:04x} ({}), store_var={:?}",
            ...
            (0x14, crate::interpreter::core::instruction::OperandCount::OP2) => {
            ...
            (0x15, crate::interpreter::core::instruction::OperandCount::OP2) => {
            ...
            (0x16, crate::interpreter::core::instruction::OperandCount::OP2) => {
            ...
            (0x17, crate::interpreter::core::instruction::OperandCount::OP2) => {
            ...
            (0x18, crate::interpreter::core::instruction::OperandCount::OP2) => {
            ...
            (0x1C, crate::interpreter::core::instruction::OperandCount::OP2) => {
    ...
    pub fn is_math_opcode(
        ...
        matches!(
            ...
            // 1OP math operations
            (0x0F, crate::interpreter::core::instruction::OperandCount::OP1) |  // not (v1-v4)
            // 2OP math operations
            (0x08, crate::interpreter::core::instruction::OperandCount::OP2) |  // or
            (0x09, crate::interpreter::core::instruction::OperandCount::OP2) |  // and
            (0x14, crate::interpreter::core::instruction::OperandCount::OP2) |  // add
            (0x15, crate::interpreter::core::instruction::OperandCount::OP2) |  // sub
            (0x16, crate::interpreter::core::instruction::OperandCount::OP2) |  // mul
            (0x17, crate::interpreter::core::instruction::OperandCount::OP2) |  // div
            (0x18, crate::interpreter::core::instruction::OperandCount::OP2) |  // mod
            (0x1C, crate::interpreter::core::instruction::OperandCount::OP2) // not (v1-v3)
        )
    }
}
