...
use crate::interpreter::opcodes::opcode_tables;
...
impl Instruction {
    ...
    pub fn decode(memory: &[u8], addr: usize, version: u8) -> Result<Self, String> {
        ...
        if addr == 0x06f91
            ...
            || addr == 0x08cbc
            || addr == 0x05953
            || addr == 0x11c3  // PC corruption crash location
        ...
        let expected_count = crate::interpreter::opcodes::opcode_tables::get_expected_operand_count(
            opcode,
            ext_opcode,
            form,
            operand_count,
    ...
    fn stores_result(
        ...
        crate::interpreter::opcodes::opcode_tables::stores_result(
            opcode,
            ext_opcode,
            form,
            operand_count,
    ...
    fn has_branch(
        ...
        crate::interpreter::opcodes::opcode_tables::has_branch(
            opcode,
            ext_opcode,
            form,
            operand_count,
    ...
    fn has_text(
        ...
        crate::interpreter::opcodes::opcode_tables::has_text(
            opcode,
            ext_opcode,
            form,
            operand_count,
    ...
    pub fn name(&self, version: u8) -> &'static str {
        crate::interpreter::opcodes::opcode_tables::get_instruction_name(
            self.opcode,
            self.ext_opcode,
            self.form,
            self.operand_count,
