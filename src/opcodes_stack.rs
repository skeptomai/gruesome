...
impl Interpreter {
    ...
    pub fn execute_stack_op(&mut self, inst: &Instruction, operands: &[u16]) -> Result<ExecutionResult, String> {
        match (inst.opcode, &inst.operand_count) {
            ...
            (0x09, crate::instruction::OperandCount::OP0) => {
            ...
            (0x08, crate::instruction::OperandCount::OP1) => {
            ...
            (0x08, crate::instruction::OperandCount::VAR) => {
            ...
            (0x09, crate::instruction::OperandCount::VAR) => {
