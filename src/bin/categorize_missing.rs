...
fn main() -> Result<(), Box<dyn std::error::Error>> {
    ...
    let missing_routines = vec![
        ...
        0x25b9c, 0x25bc0, 0x275a8, 0x27618, 0x27890, 0x279c4,
        0x27b24, 0x2846c, 0x289a4, 0x28d24, 0x2b248, 0x2d768,
        0x2d840, 0x2d868, 0x319b4, 0x32f94, 0x33c04, 0x35a44,
    ...
    println!("\nFall-through (no proper terminator): {} routines", fall_through.len());
    for &addr in &fall_through {
        println!("  {:05x}", addr);
    }
    
    println!("\nData-referenced (valid but not in code flow): {} routines", data_referenced.len());
