    ...
    pub fn generate_instruction(
        ...
        match instruction {
            ...
            IrInstruction::InsertObj {
                ...
                // DISABLED (Oct 18, 2025): InsertObj generation moved to pending instruction system
                // Problem: This old code uses resolve_ir_id_to_operand which resolves IR IDs to wrong object numbers
                // Example: forest_path IR ID 26 → resolves to IR ID 26 instead of Object #6
                // Solution: InsertObj instructions now generated in codegen.rs using pending_insertobj_instructions
                // with correct object table mappings after object table generation completes
                log::debug!(
                    "🚫 SKIPPING OLD InsertObj: object IR {} → destination IR {} (handled by pending system)",
                    object, destination
                );
                // Skip this instruction - it will be handled by the pending instruction system
            }
