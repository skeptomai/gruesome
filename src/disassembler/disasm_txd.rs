use crate::interpreter::core::instruction::{
    Instruction, InstructionForm, OperandCount, OperandType,
};
...
impl<'a> TxdDisassembler<'a> {
    ...
    fn is_valid_opcode(instruction: &Instruction, version: u8) -> bool {
        use crate::interpreter::core::instruction::{InstructionForm, OperandCount};
    ...
    fn check_instruction_targets(&mut self, instruction: &Instruction, pc: u32) {
        ...
        let is_timed_read = self.version >= 4
            && instruction.form == crate::interpreter::core::instruction::InstructionForm::Variable
    ...
    fn get_opcode_name(&self, instruction: &Instruction) -> String {
        ...
        let name = crate::interpreter::opcodes::opcode_tables::get_instruction_name(
            instruction.opcode,
